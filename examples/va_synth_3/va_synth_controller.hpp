...
=============================================================================*/
#if !defined(QPLUG_VA_SYNTH_3_CONTROLLER_SEPTEMBER_11_2026)
#define QPLUG_VA_SYNTH_3_CONTROLLER_SEPTEMBER_11_2026
...
inline q::frequency va_synth_controller::chorus_rate() const
{
   return get_parameter<q::frequency>(chorus_rate_id);
}

inline q::duration va_synth_controller::chorus_depth() const
{
   return get_parameter<duration>(chorus_depth_id);
}
