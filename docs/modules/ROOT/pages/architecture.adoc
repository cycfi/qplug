...
image::/qplug/parts.svg[alt="the three parts", width=520px, role=center]
...
* *MIDI dialects.* Notes arrive as the host chose to send them. A processor
  writes MIDI 2.0 overloads and receives every dialect, MIDI 1.0 and CLAP's
  own notes widened to it.
